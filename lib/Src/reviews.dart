...
class _ReviewsScreenState extends State<ReviewsScreen> {
  ...
  String userUid = 'LWlSF98DAybndChEnhgErYM2DcI2';
        ...
        builder: (context,
          ...
          return StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                final percentage = (countUpVote ?? 0) / 10 * 100;
                //For CouracelSlider
                            ...
                            child: Scaffold(
                              ...
                              body: NestedScrollView(
                                ...
                                body: RefreshIndicator(
                                  onRefresh: () => refreshList().then((value) =>
                                      DataBase().refresh(context, id)),
              ...
              Center(
                child: GestureDetector(
                  onTap: () => {
                    ...
                    Navigator.pop(context),
                    DataBase()
                        .rateStars(widget.movieUid, getRatingString(), userUid)
                  },
                  child: const Text(
                    'Confirm',
...
//Dialog show ratings
  Future openDialog3(percesntage, countStars1, countStars2, countStars3,
